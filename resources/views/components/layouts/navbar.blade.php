    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul
                ...
                <li>
                    <a href="#"
                        class="block py-auto px-3 text-vintage-brem bg-vintage-light rounded-sm md:bg-transparent md:p-0 dark:text-white md:dark:text-white hover:text-vintage-dark dark:hover:text-vintage-dark">Contact</a>
                </li>
            </ul>
        </div>
    </div>
